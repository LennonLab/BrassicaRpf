...
- I sequenced the DNA and cDNA 16S rRNA gene to determine how Rpf treatment affected the soil bacterial community richness, diveristy, and composition at the end of the growth chamber experiment. 
...
legend(0, 1, c("Active Rpf-", "Active Rpf+", "Total Rpf-", "Total Rpf+"),
       ...
       bty = "n", y.intersp = 1, pt.cex = 4, cex = 2)
```
