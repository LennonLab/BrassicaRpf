...
png(filename="../figures/Fig5.Actinobacteria.png",
...
# Show Plot
img <- readPNG("../figures/Fig5.Actinobacteria.png")
grid.raster(img)
```
...
```{r}
png(filename="../figures/FigX.solub.png",
...
# Show Plot
img <- readPNG("../figures/FigX.solub.png")
grid.raster(img)
```
