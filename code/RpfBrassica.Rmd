...
# Import Shared Files
OTU <- read.otu(shared = shared, cutoff = "0.03") # Using 97% similarity cut-off

# Import Taxonomy
OTU.tax <- read.tax(taxonomy = taxon, format = "rdp") # This function is not working, must fix 

# Import Phylogenetic tree 
OTU.tre <- read.tree("../phylo/Brassica.bac.rename.tree.2") # Revised with updated KBS 16S gene sequences
```
