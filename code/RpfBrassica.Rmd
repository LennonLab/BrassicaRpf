...
gpos.bray.permanova <- adonis(Gpos.OTU.REL ~ Brassica.div$type + Brassica.div$treatment + Brassica.div$pot +
...
# Statistics
Gram.Ratio.ttest <- t.test(Con.Gram.Ratio, Rpf.Gram.Ratio, alternative="greater")
Gram.Ratio.ttest  # Non-significant: t = 1.3691, df = 13.303, p = 0.09682
```
